...
const Home = () => {
  return <div className='h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      ...
      xl:text-left h-full container mx-auto'>
        ...
        <motion.p variants={fadeIn('down', 0.3)} initial='hidden' animate='show' exit='hidden' className='max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16'>
          I am a Backend Developer(Python) with years of experience in the field 
          executing complete software development from planning to development
    ...
    <div className='w-[1200px] h-full absolute right-0 bottom-0'>
      ...
      <ParticlesConatainer/>
      {/* avatar image */}
      <motion.div variants={fadeIn('up', 0.5)} initial='hidden' animate='show' exit='hidden' transition={{duration: 1, ease:easeInOut}} className='w-full h-full max-w-[600px] max-h-[678px] absolute -bottom-32 lg:bottom--10 lg:right-[8%] '>
        <Avatar/>
      </motion.div>
    </div>
  </div>;
